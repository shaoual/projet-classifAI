  ...
  <main class="main-content">
    ...
    <form class="space-y-6 mt-10 mb-36 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <div class="md:col-span-2 flex justify-center m-4">
        <button class="bg-purple-500 text-white font-bold rounded py-2 px-10 mb-5" type="button" @click="register" :disabled="!acceptedConditions">S'inscrire</button>
      </div>
